        ...
        <nav class="nav container">
            ...
            <div class="nav_menu" id="nav-menu">
                <ul class="nav_list">
                    ...
                    <li class="nav_item"><a href="#services" class="nav_link">SERVICIOS</a></li>
                    <li class="nav_item"><a href="#testimonial" class="nav_link">OPINIONES</a></li>
                    <li class="nav_item"><a href="#projects" class="nav_link">LO MÁS</a></li>
                    <li class="nav_item"><a href="#contact" class="nav_link">CONTACTO</a></li>
                </ul>
    ...
    <main class="main">
        ...
        <section class="home" id="home">
            <div class="home_container container grid">
                <div class="home_data">
                    <h3 class="home_data-subtitle"></h3>
                    <h1 class="home_data-title">Activate <b>durante las</b><br>Rutinas</h1>
                    ...
                    <a download="" href="assets/cv/Joey-CV.pdf" class="button">Descargar CV</a>
                </div>
                <div class="home_img">
                ...
                <div class="home_social">
                    <a href="https://www.facebook.com/" target="_blank" class="home_social-link"><i class="fa-brands fa-facebook"></i></a>
                    <a href="https://www.instagram.com/" target="_blank" class="home_social-link"><i class="fa-brands fa-instagram"></i></a>
                    <a href="https://www.twitter.com/" target="_blank" class="home_social-link"><i class="fa-brands fa-x-twitter"></i></a>
                </div>
            </div>
        </section>
        <!--==================== SERVICES ====================-->
        <section class="services section" id="services">
            ...
            <div class="container grid service_container">
                <div class="service_card">
                    ...
                    <span class="service_card-title">Entrenamiento Total en Casa</span>
                    <p class="body_description">Programas de entrenamiento personalizados y sesiones en vivo para ayudarte a alcanzar tus metas de fitness desde la comodidad de tu hogar.</p>
                    <a href="ejercicios.html" class="button">Ejercicios</a>
                </div>
                <div class="service_card">
                    <i class="service_icon fa-solid fa-puzzle-piece"></i>
                    <span class="service_card-title">Descubre tu Mejor Versión</span>
                    <p class="body_description">Recursos educativos y herramientas prácticas para mejorar tu bienestar físico y mental, ayudándote a descubrir tu máximo potencial.</p>
                    <a href="version.html" class="button">Descubre</a>
                </div>
                <div class="service_card">
                    <i class="service_icon fa-solid fa-people-robbery"></i>
                    <span class="service_card-title">Lista de tareas</span>
                    <p class="body_description">Un servicio completo de asesoramiento para ayudarte a adoptar un estilo de vida saludable y transformar tu bienestar de adentro hacia afuera.</p>
                    <a href="asesorar.html" class="button">TODO list</a>
                </div>
            </div>
        </section>
        <!--==================== TESTIMONIAL ====================-->
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="testimonial_card swiper-slide">
                        <div class="testimonial_data">
                            ...
                            <div class="testimonial_title">
                                <h2 class="capture_text">Ana Maria</h2>
                    ...
                    <div class="testimonial_card swiper-slide">
                        <div class="testimonial_data">
                            ...
                            <div class="testimonial_title">
                                <h2 class="service_card-title">Pedro Muños</h2>
                    ...
                    <div class="testimonial_card swiper-slide">
                        <div class="testimonial_data">
                            <img src="assets/img/testimonial1.jpg" alt="" class="testimonial_img">
                            <div class="testimonial_title">
                                <h2 class="service_card-title">Fernanda Montiel</h2>
                                <span class="capture_text">36 años</span>
                            </div>
                            <p class="body_description">
                                "¡Me encanta Activate Rutina! Esta aplicación ha cambiado completamente mi enfoque hacia el ejercicio y la 
                                alimentación saludable. Las rutinas de ejercicio son desafiantes pero alcanzables, y los consejos sobre deporte y 
                                dieta saludable me han ayudado a sentirme más fuerte y saludable que nunca. La mejor parte es que puedo hacer todo 
                                esto desde la comodidad de mi hogar, lo cual es perfecto para mi estilo de vida ocupado. ¡Recomiendo esta aplicación 
                        ...
                        <div class="project_card">
                            ...
                            <div class="project_content">
                                <div class="project_data">
                                    ...
                                    <span class="project_subtitle">' . $row["subtitulo"] . '</span>
                                    <span class="project_data">' . $row["fecha"] . '</span>
                                </div>
                            </div>
                            <button class="button button--flex project_button" id="irpagina">
                                ' . $row["demo"] . ' <i class="fa-solid fa-arrow-right"></i>
                            </button>
                        </div>
                        ';
                    }
            ...
            <div class="">
                ...
                <div class="contact_container container grid">
                    ...
                    <div class="contact_content">
                        <form action="contacto.php" method="POST" class="contact_form grid">
                            <input type="text" name="name" placeholder="Nombre completo" class="contact_input" required>
                            <input type="email" name="email" placeholder="Correo electronico" class="contact_input" required>
                            <textarea name="message" rows="8" class="contact_input" placeholder="Tu mensaje" required></textarea>
